...
=================
*/
static void Model_NextDownload ()
{
	char	*s;
	int		i;
...
=================
*/
static void Sound_NextDownload ()
{
	char	*s;
	int		i;
